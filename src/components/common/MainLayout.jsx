  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex">
        ...
        {/* Right Sidebar */}
        {showNav && (
          <aside className="w-64 bg-secondary text-text-light p-4 flex flex-col">
            ...
            <nav className="mb-auto">
              <ul className="space-y-4">
                ...
                <li>
                  <Link 
                    to="/upload" 
                    className={`block py-2 px-4 rounded-md ${location.pathname === '/upload' ? 'bg-accent text-text-dark' : 'hover:bg-secondary-dark'} transition-colors`}
                  >
                    CSV Upload
                  </Link>
                </li>
            ...
            <div className="mt-auto relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute bottom-full right-0 mb-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                  <Link 
                    to="/profile" 
